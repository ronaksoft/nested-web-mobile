...
export default class AddEditor extends React.Component <IProps, any> {
  public render() {
      ...
      <a className={[style.notifWrapper].join(' ')}>
        ...
        <div className={style.notifContainer}>
          <div className={style.notifData}>
            ...
            {activity.editors.length === 1 && <aside>Added a editor:</aside>}
            {activity.editors.length > 1 && <aside>Added editors:</aside>}
