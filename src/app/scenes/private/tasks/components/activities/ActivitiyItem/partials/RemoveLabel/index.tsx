...
export default class RemoveLabel extends React.Component <IProps, any> {
  public render() {
      ...
      <a className={[style.notifWrapper].join(' ')}>
        ...
        <div className={style.notifContainer}>
          <div className={style.notifData}>
            ...
            {activity.labels.length === 1 && <aside>Removed a label:</aside>}
            {activity.labels.length > 1 && <aside>Removed labels:</aside>}
