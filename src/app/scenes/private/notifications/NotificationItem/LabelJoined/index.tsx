 ...
 */
class LabelJoined extends React.Component <IProps, any> {
  /**
   * @function render
        ...
        <div className={style.notifContainer}>
          <div className={style.notifData}>
            <p>
              ...
              your request for joining <span>{notification.label.title}</span> label is approved
